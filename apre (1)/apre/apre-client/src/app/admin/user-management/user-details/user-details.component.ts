    ...
    <div>
      ...
      <form [formGroup]="userDetailsForm" (ngSubmit)="editUser();" class="form">
        <div class="form__group">
          ...
          <!-- Added placeholder attribute to provide visual guidance to users about the expected input -->
          <!-- This improves user experience by making the form more self-explanatory -->
